import{a5 as P,b as T}from"./app-core.0df0f3ff.js";import{_ as d}from"./vendor-other.7ee0c845.js";import{n as x,aq as g,f as C,i as A,j as M,a0 as _,R as y,Q as N,T as k,M as R,ae as W,U as O,P as H,ax as j}from"./vendor-vue-ui.7850d25d.js";import{_ as G}from"./Button.a02c1bcb.js";import{B as q}from"./Img.5abec1e8.js";import{B as D}from"./Input.b807588c.js";import{S as J}from"./Plus.f4b8e7e7.js";import{_ as Y}from"./Trash.da4a6344.js";import{_ as F}from"./_plugin-vue_export-helper.eefbdd86.js";const b="all-in-one-seo-pack",L=()=>typeof window.wp?.media=="function"?window.wp.media:typeof window.parent?.wp?.media=="function"?window.parent.wp.media:null,Q=()=>{let e=null;const n=({title:i,buttonText:a,multiple:s=!1,type:r=null,onSelect:c})=>{e=L()({title:i,button:{text:a},multiple:s,library:r?{type:r}:{}}),e.on("select",()=>{const u=e.state().get("selection"),l=u.first();l&&c(s?u.toJSON():l.toJSON())}),e.on("close",()=>e.detach()),x(()=>{e.open()})},t=({multiple:i=!1,type:a=null,onSelect:s})=>{const u=(T().aioseo?.urls?.home||window.location.origin).replace(/\/$/,"")+"/u-kasi/wp-admin/",l=new URLSearchParams({breakdance_wpuiforbuilder_media:"1"});a&&l.set("types",a),i&&l.set("multiple","1");const o=document.createElement("div");if(o.className="aioseo-media-uploader-overlay",o.innerHTML=`
