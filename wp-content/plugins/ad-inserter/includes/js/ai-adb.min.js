...
d,{expires:365,path:"/u-kasi/"});window.ai_d1=d;ai_adb_message_code_1();return}if(0!=c&&(AiCookies.set(ai_adb_pgv_cookie_name,d,{expires:365,path:"/u-kasi/"}),0!=(d-b-1)%c)){window.ai_d1=d;ai_adb_message_code_1();return}}if(0==ai_adb_message_cookie_lifetime||1==ai_adb_action&&ai_adb_message_undismissible)AiCookies.remove(ai_adb_act_cookie_name,{path:"/u-kasi/"});else{e=AiCookies.get(ai_adb_act_cookie_name);if("undefined"!=typeof e&&e==ai_adb_cookie_value){ai_adb_message_code_2();return}AiCookies.set(ai_adb_act_cookie_name,
ai_adb_cookie_value,{expires:ai_adb_message_cookie_lifetime,path:"/u-kasi/"})}0==ai_adb_action?(ai_dummy=16,ai_adb_message_code_6(),ai_dummy++):(ai_adb_message_code_3(),ai_dummy=13);switch(ai_adb_action){case 1:ai_adb_message_undismissible?(ai_adb_overlay.querySelectorAll('[style*="cursor"]').forEach((a,f)=>{a.style.cursor="no-drop"}),ai_adb_message_window.querySelectorAll('[style*="cursor"]').forEach((a,f)=>{a.style.cursor="no-drop"})):(ai_adb_overlay.addEventListener("click",a=>{ai_adb_overlay.remove();
...
4)?window.location.href==ai_adb_redirection_url&&(b=!1):window.location.pathname==ai_adb_redirection_url&&(b=!1),b?(e=AiCookies.get(ai_adb_page_redirection_cookie_name),"undefined"==typeof e&&(b=new Date,b.setTime(b.getTime()+1E4),AiCookies.set(ai_adb_page_redirection_cookie_name,window.location.href,{expires:b,path:"/u-kasi/"}),"?"==ai_adb_redirection_url.substr(ai_adb_redirection_url.length-1)&&(ai_adb_redirection_url=ai_adb_redirection_url.slice(0,-1),ai_adb_redirection_url+=location.search),window.location.replace(ai_adb_redirection_url))):
AiCookies.remove(ai_adb_page_redirection_cookie_name,{path:"/u-kasi/"}))}}},ai_adb_undetected=function(b){setTimeout(function(){ai_adb_active||ai_adb_undetected_actions(b)},200)},ai_adb_undetected_actions=function(b){ai_adb_counter++;ai_adb_active||4!=ai_adb_counter||(document.querySelector(b64d("Ym9keQ==")).setAttribute(b64d(ai_adb_attribute),b64d("Y2xlYXI=")),ai_dummy=11,ai_adb_message_code_4(),ai_dummy=14,l())};AI_DBG_AI_DEBUG_AD_BLOCKING&&k(function(){ai_adb_detected(0)});function n(b,c){var d=document.createElement("script");
d.src="ai-adb-url"+b+".js?ver="+(new Date).getTime();var e=document.getElementsByTagName("head")[0],a=!1;d.onerror=function(){c&&c();d.onerror=null;e.removeChild(d)};d.onload=d.onreadystatechange=function(){a||this.readyState&&"loaded"!=this.readyState&&"complete"!=this.readyState||(a=!0,c&&c(),d.onload=d.onreadystatechange=null,e.removeChild(d))};e.appendChild(d)}const r=async()=>{try{const b=await fetch(b64d("aHR0cHM6Ly9wYWdlYWQyLmdvb2dsZXN5bmRpY2F0aW9uLmNvbS9wYWdlYWQvanMvYWRzYnlnb29nbGUuanM="),
...
e=>{AiCookies.remove(ai_adb_act_cookie_name,{path:"/u-kasi/"});AiCookies.remove(ai_adb_pgv_cookie_name,{path:"/u-kasi/"});ai_adb_message_code_5();ai_dummy=15})},5);if((!ai_adb_active||ai_debugging_active)&&""!=ai_adb_selectors){var b=0,c=0,d=ai_adb_selectors.split(",");d.forEach((e,a)=>{d[a]=d[a].trim();null!=document.querySelector(d[a])&&document.querySelectorAll(d[a]).forEach((f,g)=>{var h=f.offsetHeight;f.querySelectorAll(".ai-attributes").forEach((p,t)=>{h>=p.offsetHeight&&(h-=p.offsetHeight)});b++;if(0===
